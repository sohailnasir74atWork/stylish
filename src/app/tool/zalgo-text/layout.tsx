...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        type: 'website',
        images: [{ url: `${SITE_URL}/og-image.png`, width: 1200, height: 630, alt: 'Zalgo Text' }],
    },
    twitter: {
...
export default async function Layout({ children }: { children: React.ReactNode }) {
    ...
    const breadcrumbSchema = {
        ...
        itemListElement: [
            ...
            { '@type': 'ListItem', position: 3, name: 'Zalgo Text', item: `${SITE_URL}/tool/zalgo-text` },
        ],
    };
    ...
    const webPageSchema = {
        '@context': 'https://schema.org',
        '@type': 'WebPage',
        name: 'Zalgo Text Generator — Creepy Glitch Text Maker',
        description: 'Create creepy, glitchy zalgo text that looks cursed or corrupted. Adjust intensity & direction. Copy and paste on Discord, WhatsApp, social media & more!',
        url: `${SITE_URL}/tool/zalgo-text`,
