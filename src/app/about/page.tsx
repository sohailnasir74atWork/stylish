                ...
                <div className="space-y-6 text-gray-300 leading-relaxed">
                    ...
                    <div className="bg-black/5 dark:bg-white/5 rounded-2xl border border-black/8 dark:border-white/10 p-6 sm:p-8">
                        ...
                        <ul className="space-y-2 list-disc list-inside">
                            <li><strong className="text-gray-900 dark:text-white">1000+ Font Styles</strong> — From bold and italic to gothic, cursive, bubble, and more</li>
                            <li><strong className="text-gray-900 dark:text-white">70+ Decorators</strong> — Beautiful symbols and frames to wrap your name</li>
                            <li><strong className="text-gray-900 dark:text-white">Instant Copy</strong> — One-click to copy any style to your clipboard</li>
                            <li><strong className="text-gray-900 dark:text-white">Category Filters</strong> — Gaming, Cute, Cool, Fancy, Love, and more</li>
                            <li><strong className="text-gray-900 dark:text-white">Platform-Specific</strong> — Optimized for Instagram, TikTok, PUBG, Free Fire</li>
                            <li><strong className="text-gray-900 dark:text-white">Always Free</strong> — No sign-up, no downloads, no limits</li>
                        </ul>
                    </div>
