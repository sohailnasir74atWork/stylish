            ...
            <div className="relative overflow-hidden rounded-2xl border border-yellow-500/20 bg-gradient-to-r from-yellow-900/10 via-orange-900/5 to-red-900/10 p-5 sm:p-6">
                ...
                <div className="relative">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <span className="text-xs text-gray-500">{names.length} curated names</span>
                    </div>
                    ...
                    {names.length > 8 && !showAll && (
                        <button
                            ...
                            className="mt-3 w-full py-2.5 rounded-xl text-xs font-medium text-purple-400 bg-white/5 hover:bg-white/10 transition-all border border-white/5"
                        >
